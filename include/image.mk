...
SQUASHFSOPTS :=
ifeq ($(CONFIG_KERNEL_SQUASHFS_GZIP),y)
  SQUASHFSOPTS += -comp gzip -Xstrategy default,filtered,huffman_only,run_length_encoded,fixed
endif
ifeq ($(CONFIG_KERNEL_SQUASHFS_LZ4),y)
  SQUASHFSOPTS += -comp lz4 -Xhc
endif
ifeq ($(CONFIG_KERNEL_SQUASHFS_LZO),y)
  SQUASHFSOPTS += -comp lzo -Xalgorithm lzo1x_999 -Xcompression-level 9
endif
ifeq ($(CONFIG_KERNEL_SQUASHFS_XZ),y)
  SQUASHFSOPTS += -comp xz -Xpreset 9 -Xe -Xlc 0 -Xlp 2 -Xpb 2
  ifneq ($(filter arm x86 powerpc sparc,$(LINUX_KARCH)),)
    SQUASHFSOPTS += -Xbcj $(LINUX_KARCH)
  endif
endif
ifeq ($(CONFIG_KERNEL_SQUASHFS_ZSTD),y)
  SQUASHFSOPTS += -comp zstd -Xcompression-level 22
endif
SQUASHFS_BLOCKSIZE := $(CONFIG_TARGET_SQUASHFS_BLOCK_SIZE)k
SQUASHFSOPTS += -b $(SQUASHFS_BLOCKSIZE)
SQUASHFSOPTS += -p '/dev d 755 0 0' -p '/dev/console c 600 0 0 5 1'
...
define Image/mkfs/squashfs-common
	$(STAGING_DIR_HOST)/bin/mksquashfs4 $(call mkfs_target_dir,$(1)) $@ \
		-nopad -noappend -root-owned $(SQUASHFSOPTS)
endef
